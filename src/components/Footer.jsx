...
function Footer() {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".2" className='w-full flex h-screen bg-zinc-900'>
      <div className='w-1/2 flex flex-col justify-between   h-full'>
        <div className='heading  font-["Founders Grotest"] py-24 px-10 '>
          <h1 className='text-zinc-200 font-semibold tracking-tighter leading-[80px] text-8xl '>EYE-<br />
            OPENING</h1>

        </div>
        <div className='px-12 py-8'>
          <svg width="72" height="28" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className='w-1/2 h-full' >
        <div className='heading  font-["Founders Grotest"] py-24  '>
          <h1 className='text-zinc-200 font-semibold tracking-tighter leading-none text-[6.7vw] '>PRESENTATIONS</h1>
          <div className='font-["Neue Montreal] font-light text-md mt-10'>
            <h1>S:</h1>

            <a className='block underline mt-2' href="">Instagram</a>
            <a className='block underline ' href="">LinkedIn</a>
            <a className='block underline ' href="">Twitter</a>
            <a className='block underline ' href="">Behance</a>

          </div>
          <div className='font-["Neue Montreal] font-light text-md mt-10'>
            <h1>L:</h1>
            <a className='block underline mt-2' href="">202-1965<br /> W 4th Ave
              Vancouver, Canada</a>
            <a className='block underline  mt-5' href="">30 Chukarina St<br />
              Lviv, Ukraine</a>
          </div>
          {/* <div className='font-["Neue Montreal] font-light text-md mt-10'>
            <h1>E:</h1>
            <a className='block underline mt-2' href="">hello@ochi.design</a>
     
          </div> */}
          <div className='font-["Neue Montreal] font-light text-md mt-10'>
           
            <a className='block  mt-2' href="">Design and Develop by &copy;
            <span className='underline'>SOHEL SHAIKH</span></a>
