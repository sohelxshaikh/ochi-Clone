...
function Navbar() {
  ...
  return (
    <div className={`fixed z-[99999] flex w-full px-20 py-8 font-["Neue Montreal" ] bg-zinc-900  justify-between transition-all duration-600 ${isVisible ? 'top-0' : '-top-full'}`} >
      <div className="logo">
