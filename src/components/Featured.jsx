                ...
                <div className='cards w-full gap-10 flex  '>
                    ...
                    <div className='cardcontainer w-1/2 h-full'>
                        <div className="  card relative w-full  h-[75vh] rounded-lg">
                            <h1 className='text-8xl overflow-hidden flex text-[#CDEA68] tracking-tighter leading-none absolute left-full -translate-x-1/2  top-1/2 -translate-y-1/2'>
                                {"FYDY".split("").map((item , index)=>
                                    <motion.span initial={{y:"100%"}} whileHover={{y:"0"}} className='inline-bloack'>{item}</motion.span>
                                )}
                            </h1>
